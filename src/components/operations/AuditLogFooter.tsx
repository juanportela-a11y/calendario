...
export const AuditLogFooter: React.FC<AuditLogFooterProps> = ({ logs }) => {
  ...
  const getModuleBadge = (modulo: RegistroAuditoria['modulo']) => {
    switch (modulo) {
      ...
      case 'Eventos':
        return {
          bg: 'bg-purple-100 dark:bg-purple-950 text-purple-800 dark:text-purple-300',
          icon: <Clock className="w-3 h-3" />
        };
      case 'Avisos':
        return {
          bg: 'bg-rose-100 dark:bg-rose-950 text-rose-800 dark:text-rose-300',
          icon: <Sparkles className="w-3 h-3" />
        };
      case 'Usuarios':
        return {
          bg: 'bg-blue-100 dark:bg-blue-950 text-blue-800 dark:text-blue-300',
          icon: <UserCheck className="w-3 h-3" />
        };
      default:
        return {
          bg: 'bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-300',
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <option value="Eventos">Eventos Comunitarios</option>
                <option value="Avisos">Avisos Oficiales</option>
                <option value="Usuarios">Usuarios & Sesiones</option>
                <option value="Cortes">Cortes de Servicios</option>
                <option value="Salud & Esterilización">Zoonosis & Salud</option>
                <option value="Notificaciones">Notificaciones</option>
                <option value="Ciudadanía">Participación Ciudadana</option>
