...
export const INITIAL_USERS: Usuario[] = [
  {
    id_usuario: 1,
    nombre_usuario: 'Juan David Morales (Ciudadano)',
    correo: 'habitante@purificacion-tolima.gov.co',
    contrasena: '123456',
    rol: 'habitante',
    preferencias_categorias: ['cultura', 'deporte', 'educacion'],
    fecha_registro: '2026-01-15',
    telefono: '3101234567',
    barrio: 'Barrio El Modelo',
    puntos_civicos: 120
  },
  {
    id_usuario: 2,
  ...
  {
    id_usuario: 6,
    nombre_usuario: 'María Fernanda Ospina (Habitante Chenche)',
    correo: 'ciudadano@purificacion-tolima.gov.co',
    contrasena: '123456',
    rol: 'habitante',
    preferencias_categorias: ['salud', 'bienestar', 'cultura'],
...
export const INITIAL_NOTIFICATIONS: Notificacion[] = [
  {
    ...
    mensaje: 'Has iniciado sesión como Habitante de Purificación. Puedes guardar tus eventos favoritos, reportar incidentes viales y acumular PurifiPuntos.',
    fecha: 'Hoy',
    leida: false,
    tipo_ref: 'sistema',
    id_ref: null
  },
  {
    id_notificacion: 2,
    id_usuario: 1,
    titulo: 'Alerta de Mantenimiento de Agua',
    mensaje: 'Empresas Públicas de Purificación informa lavado de tanques que afectará a tu sector (Barrio El Modelo).',
    fecha: 'Hoy',
    leida: false,
    tipo_ref: 'aviso',
    id_ref: 1
  },
  {
    id_notificacion: 3,
    id_usuario: 1,
    titulo: 'Recordatorio de Evento Guardado',
    mensaje: 'El Festival Folclórico y Cultural del Río Magdalena comenzará pronto en el Malecón Turístico.',
    fecha: 'Ayer',
    leida: true,
    tipo_ref: 'evento',
    id_ref: 1
...
export const INITIAL_USER_EVENTS: UsuarioEvento[] = [
  {
    ...
    id_usuario: 1,
    id_evento: 1,
    fecha_guardado: '2026-02-15'
  },
  {
    id_usuario_evento: 2,
    id_usuario: 1,
    id_evento: 2,
    fecha_guardado: '2026-02-18'
  }
];
