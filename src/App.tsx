...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F0F6FF] text-slate-800 flex flex-col font-sans selection:bg-[#2196F3] selection:text-white">
          ...
          <div className="space-y-10">
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-xs space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-black text-slate-900 uppercase tracking-wider text-[#0D47A1]">
                  Categorías Principales del Municipio
                </h3>
                <button 
                  onClick={() => setActiveTab('calendario')}
                  className="text-xs font-bold text-[#2196F3] hover:underline flex items-center gap-1"
                >
                  <span>Ver todas</span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
                {categories.map((cat) => (
                  <button
                    ...
                    className="p-3.5 rounded-2xl border border-slate-100 hover:border-blue-300 bg-slate-50 hover:bg-blue-50/50 transition-all text-left flex flex-col justify-between group"
                  >
                    <span 
                      className="w-3 h-3 rounded-full mb-2 group-hover:scale-125 transition-transform" 
                      style={{ backgroundColor: cat.color }}
                    />
                    <p className="text-xs font-bold text-slate-900 leading-tight">{cat.nombre}</p>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-blue-50 text-[#0D47A1] text-xs font-bold hover:bg-blue-100 transition-colors flex items-center gap-1.5"
                >
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-xs font-bold transition-all border whitespace-nowrap flex items-center gap-1.5 ${
                        isSelected ? 'text-white shadow-xs' : 'bg-slate-50 text-slate-700 hover:bg-slate-100'
                      }`}
                      style={{
      ...
      {/* Footer */}
      <footer className="bg-[#0D47A1] text-blue-100 py-10 mt-16 border-t border-blue-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          <div className="flex items-center justify-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-white text-[#0D47A1] font-black text-lg flex items-center justify-center">
              P
            </div>
          ...
          <div className="pt-4 border-t border-blue-800 text-[11px] text-blue-300 flex flex-col sm:flex-row items-center justify-between gap-2">
